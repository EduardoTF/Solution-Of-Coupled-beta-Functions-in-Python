...
g=np.array([sqrt(5.0/3.0)*(0.35940), 0.64754, 1.1666]) #Initial conditions of [g1(mt),g2(mt),g2(mt)]
...
def alpha_2S(Q): 0#Coupling constant alpha_2 for the MSSM at 1 loop
